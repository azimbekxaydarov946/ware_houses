        ...
        <div class="row">
          ...
          <div class="col-lg-6 bg-white">
            <div class="form d-flex align-items-center">
              <div class="content">
                <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post" class="text-left form-validate">
                  ...
                  <div class="form-group-material">
                    <input id="register-password" type="password" name="password" required data-msg="Please enter your password" class="input-material" minlength="8">
